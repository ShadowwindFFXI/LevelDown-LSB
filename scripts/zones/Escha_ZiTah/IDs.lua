...
zones[xi.zone.ESCHA_ZITAH] =
{
    text =
    {
        ...
        RETURN_TO_BATTLEFIELD         = 7650, -- <1F:7B>You have strayed too far from the monster's spawn point, and your evaluation will be reset if you do not return to the field of battle.
        DOMAIN_POINTS_OBTAINED        = 7659, -- <1F:79>{player:name} obtained {0} Domain Points!
        ESCHA_BEADS_EARNED            = 7710, -- You receive {0} escha beads.
    },
    mob =
    {
