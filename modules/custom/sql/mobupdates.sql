...
INSERT INTO mob_skill_lists VALUES('Azi_Dahaka', 50010, 1285);
INSERT INTO mob_skill_lists VALUES('Azi_Dahaka', 50010, 4218);
INSERT INTO mob_skill_lists VALUES('Azi_Dahaka', 50010, 1286);
INSERT INTO mob_skill_lists VALUES('Azi_Dahaka', 50010, 1279);
INSERT INTO mob_skill_lists VALUES('Azi_Dahaka', 50010, 4291);
UPDATE mob_pools SET skill_list_id = 50010, spellList = 526 WHERE name = 'Azi_Dahaka';
INSERT INTO mob_skill_lists VALUES('Naga_Raja', 50011, 1292);
INSERT INTO mob_skill_lists VALUES('Naga_Raja', 50011, 4219);
INSERT INTO mob_skill_lists VALUES('Naga_Raja', 50011, 1289);
INSERT INTO mob_skill_lists VALUES('Naga_Raja', 50011, 1296);
INSERT INTO mob_skill_lists VALUES('Naga_Raja', 50011, 4291);
INSERT INTO mob_skill_lists VALUES('Naga_Raja', 50011, 1293);
UPDATE mob_pools SET skill_list_id = 50011, mJob = 8, sJob = 4, spellList = 526 WHERE name = 'Naga_Raja';
INSERT INTO mob_skill_lists VALUES('Quetzalcoatl', 50012, 1309);
INSERT INTO mob_skill_lists VALUES('Quetzalcoatl', 50012, 1316);
INSERT INTO mob_skill_lists VALUES('Quetzalcoatl', 50012, 4220);
INSERT INTO mob_skill_lists VALUES('Quetzalcoatl', 50012, 4291);
INSERT INTO mob_skill_lists VALUES('Quetzalcoatl', 50012, 3789);
UPDATE mob_pools SET skill_list_id = 50012, spellList = 526 WHERE name = 'Quetzalcoatl';
INSERT INTO mob_skill_lists VALUES('Mireu', 50013, 1045);
INSERT INTO mob_skill_lists VALUES('Mireu', 50013, 2696);
INSERT INTO mob_skill_lists VALUES('Mireu', 50013, 1046);
INSERT INTO mob_skill_lists VALUES('Mireu', 50013, 1039);
INSERT INTO mob_skill_lists VALUES('Mireu', 50013, 4223);
INSERT INTO mob_skill_lists VALUES('Mireu', 50013, 4225);
INSERT INTO mob_skill_lists VALUES('Mireu', 50013, 4292);
INSERT INTO mob_skill_lists VALUES('Mireu', 50013, 4224);
UPDATE mob_pools SET skill_list_id = 50013, mJob = 8, sJob = 4, spellList = 526 WHERE name = 'Mireu';
UPDATE mob_spawn_points SET minLevel = 119, maxLevel = 119 WHERE mobname = 'Azi_Dahaka' AND groupid = 64;
UPDATE mob_spawn_points SET minLevel = 119, maxLevel = 119 WHERE mobname = 'Naga_Raja' AND groupid = 96;
UPDATE mob_spawn_points SET minLevel = 119, maxLevel = 119 WHERE mobname = 'Quetzalcoatl' AND groupid = 89;
UPDATE mob_spawn_points SET minLevel = 150, maxLevel = 150 WHERE mobname = 'Mireu' AND groupid = 99;
UPDATE mob_spawn_points SET minLevel = 150, maxLevel = 150 WHERE mobname = 'Mireu' AND groupid = 91;
UPDATE mob_spawn_points SET minLevel = 150, maxLevel = 150 WHERE mobname = 'Mireu' AND groupid = 66;
UPDATE mob_groups SET HP = 1450000, MP = 9999 WHERE name = 'Azi_Dahaka' AND zoneid = 288;
UPDATE mob_groups SET HP = 35000, MP = 9999 WHERE name = 'Azi_Dahakas_Dragon' AND zoneid = 288;
UPDATE mob_groups SET HP = 1450000, MP = 9999 WHERE name = 'Naga_Raja' AND zoneid = 289;
UPDATE mob_groups SET HP = 35000, MP = 9999 WHERE name = 'Naga_Rajas_Lamia_1' AND zoneid = 289;
UPDATE mob_groups SET HP = 35000, MP = 9999 WHERE name = 'Naga_Rajas_Lamia_2' AND zoneid = 289;
UPDATE mob_groups SET HP = 1450000, MP = 9999 WHERE name = 'Quetzalcoatl' AND zoneid = 291;
UPDATE mob_groups SET HP = 35000, MP = 9999 WHERE name = 'Quetzalcoatls_Sibilus' AND zoneid = 291;
UPDATE mob_groups SET HP = 4000000, MP = 9999 WHERE name = 'Mireu' AND zoneid = 288;
UPDATE mob_groups SET HP = 4000000, MP = 9999 WHERE name = 'Mireu' AND zoneid = 289;
UPDATE mob_groups SET HP = 4000000, MP = 9999 WHERE name = 'Mireu' AND zoneid = 291;